...
export default function DateNavigator({ date }: Props) {
  ...
  return (
    <div className="max-w-3xl border-b bg-black text-white py-2 px-3 flex items-center justify-between gap-2">
      ...
      <button className=" bg-gray-700 w-8 h-8 rounded flex items-center justify-center text-xs ">
        Live
      </button>
      ...
      <button
        ...
        className="w-8 h-8 bg-gray-700 text-white rounded flex items-center justify-center "
      >
        {dayOnly}
      </button>
