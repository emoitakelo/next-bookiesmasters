...
export default function DateNavigator({ date }: Props) {
  ...
  return (
    <div className="max-w-3xl mx-auto bg-black text-white py-2 px-3 flex items-center justify-between gap-2">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="text-medium font-bold text-gray-300 whitespace-nowrap">
          {formattedDate}
        </div>
