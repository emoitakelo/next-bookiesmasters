    ...
    return (
        <>
            ...
            <div className="max-w-xl mx-auto mt-4 mb-2 px-2">
                ...
                {/* HACK: We pass 'live' as the date. 
             If we update PredictionList to handle 'live' specially in the URL, this works.
             Wait, PredictionList builds URL: /api/fixtures/cards?date=${date}
             But we want /api/fixtures/live.
             
             We need to tweak PredictionList to accept an override URL or handle 'live' date string.
         */}
